...
plt.ylabel(r'$\mathit{Dw_\mathrm{dens,y}}$ [rooms/person]',  fontsize = size_font)
...
plt.xlabel('Year', fontsize = size_font)
plt.ylabel(r'$\mathit{Dw_\mathrm{area,y}}$ [m$^2$/person]',  fontsize = size_font)
...
plt.xlabel('Year', fontsize = size_font)
plt.ylabel(r'$EM_\mathrm{op,old,y}$ [MtCO$_2$eq]',  fontsize = size_font)
