...
c = Calc_func(0.61, 100000, 25, 0, 0.98,10,-200)
d = Calc_func(0.76, 0, 25, 0, 0.98,30,200)
e = Calc_func(0.61, 100000, 25, 0, 0.80,10,-200)
f = Calc_func(0.76, 0, 25, 0, 0.80,30,200)
...
plt.ylim([-0.15,3.7])
plt.legend([r'$SH_\mathrm{ren,tu}$ = 98 %, $t_\mathrm{rd,tl}$ = 10 a', r'$SH_\mathrm{ren,tu}$ = 98 %, $t_\mathrm{rd,tu}$ = 30 a' ], fontsize=size_font)
...
plt.text(2035, B_dem*100 + 0.001, 'Demolition rate 2020', fontsize=size_font-2)
plt.ylim([-0.15,3.7])
plt.legend([r'$SH_\mathrm{ren,tl}$ = 80 %, $t_\mathrm{rd,tl}$ = 10 a', r'$SH_\mathrm{ren,tl}$ = 80 %, $t_\mathrm{rd,tu}$ = 30 a' ], fontsize=size_font)
