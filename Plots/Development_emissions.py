...
plt.ylabel(r'$em_\mathrm{emb,new,y}$ [kgCO$_2$eq/m$^2$]',  fontsize = size_font)
...
plt.ylabel(r'$em_\mathrm{emb,ren,y}$ [kgCO$_2$eq/m$^2$]',  fontsize = size_font)
...
plt.xlabel('% renovated/demolished', fontsize = size_font)
plt.ylabel(r'$em_\mathrm{op,old,y}$ [kgCO$_2$eq/m$^2$/a]',  fontsize = size_font)
...
plt.xlabel('Year', fontsize = size_font)
plt.ylabel(r'$em_\mathrm{op,new,y}$ [kgCO$_2$eq/m$^2$/a]',  fontsize = size_font)
...
plt.xlabel('% renovated/demolished', fontsize = size_font)
plt.ylabel(r'$em_\mathrm{op,ren,y}$ [kgCO$_2$eq/m$^2$/a]',  fontsize = size_font)
...
plt.plot(Share,Em_op_ren) 
plt.xlabel('% renovated/demolished', fontsize = size_font)
plt.ylabel(r'Emissions [kgCO$_2$eq/m$^2$/a]',  fontsize = size_font)
plt.axhline(y=5.8,linewidth = 0.8, color = 'black', linestyle = 'dotted' )
plt.axhline(y=3.5,linewidth = 0.8, color = 'black', linestyle = 'dotted' )
plt.axhline(y=15.5,linewidth = 0.8, color = 'black', linestyle = 'dotted' )
plt.text(23, 3.6, 'Average em. op. new build. 2020', fontsize=size_font-2)
...
plt.xlabel('Year', fontsize = size_font)
plt.ylabel(r'$em_\mathrm{emb,dem,y}$ [kgCO$_2$eq/m$^2$]',  fontsize = size_font)
