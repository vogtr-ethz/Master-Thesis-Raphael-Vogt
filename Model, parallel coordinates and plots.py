    ...
    go.Parcoords(
        ...
        dimensions = list([
            ...
            dict(range = plot_range(Em_emb_ren_p),
                 ...
                 label = r'<b><i>em</i><sub>emb,ren</sub> <br /> [kgCO<sub>2</sub>eq/m<sup>2</sup>]</b>', values = df['Em_Emb_ren']),
            dict(range = plot_range(Em_emb_new_p),
                 tickvals = Em_emb_new_p.tolist(),
                 label = r'<b><i>em</i><sub>emb,new</sub>  <br /> [kgCO<sub>2</sub>eq/m<sup>2</sup>]</b>', values = df['Em_emb_new']),
            ...
            dict(range = plot_range(Em_op_old_tot_p),
                 ...
                 label = '<b><i>EM</i><sub>op,old</sub>  <br />  [MtCO<sub>2</sub>eq]', values = df['Em_Op_old_tot']),
            dict(range = plot_range(Em_op_ren_tot_p),
                 tickvals = Em_op_ren_tot_p.tolist(),
                 label = '<b><i>EM</i><sub>op,ren</sub> <br /> [MtCO<sub>2</sub>eq]', values = df['Em_Op_ren_tot']),
            dict(range = plot_range(Em_emb_ren_tot_p),
                 tickvals = Em_emb_ren_tot_p.tolist(),
                 label = '<b><i>EM</i><sub>emb,ren</sub> <br /> [MtCO<sub>2</sub>eq]', values = df['Em_Emb_ren_tot']),
            dict(range = plot_range(Em_op_new_tot_p),
                 tickvals = Em_op_new_tot_p.tolist(),
                 label = '<b><i>EM</i><sub>op,new</sub> <br /> [MtCO<sub>2</sub>eq]', values = df['Em_Op_new_tot']),
            dict(range = plot_range(Em_emb_new_tot_p),
                 tickvals = Em_emb_new_tot_p.tolist(),
                 label = '<b><i>EM</i><sub>emb,new</sub> <br /> [MtCO<sub>2</sub>eq]', values = df['Em_Emb_new_tot']),
            dict(range = plot_range(Em_dem_tot_p),
                 tickvals = Em_dem_tot_p.tolist(),
                 label = '<b><i>EM</i><sub>emb,dem</sub> <br /> [MtCO<sub>2</sub>eq]', values = df['Em_Dem_tot']),
            dict(range = plot_range(Em_tot_tot_p),
                 ...
                 label = '<b><i>EM</i><sub>tot</sub> / <i>WP</i><sub>EM,tot</sub> <br /> [MtCO<sub>2</sub>eq] / [℃]', values = df['Em_tot']),])
    )
)
...
S7_real_1_7 = Calc_func(0.66, Rooms_Unused_20/4, 38.5, -150, 0.96,16,-75)
print('Warming potential S7_real_1_75 =', warming_degree(S7_real_1_7[6])) 
S7_real_1_8 = Calc_func(0.64, Rooms_Unused_20/2, 40, -100, 0.95,20,-50)
print('Warming potential S7_real_1_8 =', warming_degree(S7_real_1_8[6])) 
...
#Comparison Best/Worst person new construction / Area new construction 
BaU_pers = [599423/1e6,26912467/1e6]
Best_pers = [S1_best[7]/1e6,S1_best[18]/1e6]
Worst_pers = [S2_worst[7]/1e6,S2_worst[18]/1e6]
X_axis = np.arange(1)
...
plt.ylim([0, 1.49])
plt.bar(X_axis - 0.2, BaU_pers[0], 0.2, label = 'Business as usual', color = plt.get_cmap('tab10')(0.4),edgecolor = 'black')
plt.bar(X_axis - 0.0, Best_pers[0], 0.2, label = 'Best scenario', color = plt.get_cmap('tab10')(0.2),edgecolor = 'black')
plt.bar(X_axis + 0.2, Worst_pers[0], 0.2, label = 'Worst scenario', color = plt.get_cmap('tab10')(0.3),edgecolor = 'black')
plt.ylabel("Persons new construction [M pers]", fontsize = 11)
plt.legend(bbox_to_anchor=(1.4, 0.5),fontsize = 11)
ax.yaxis.grid(linewidth = 0.6, color = 'black', linestyle = 'dotted' )
#plt.title('Total persons new construction best/worst scenario', x=1.1, y=1.1, fontsize = 12)
ax2 = ax.twinx()
plt.bar(X_axis + 1 - 0.2, BaU_pers[1], 0.2, label = 'Business as usual', color = plt.get_cmap('tab10')(0.4),edgecolor = 'black')
plt.bar(X_axis + 1 - 0.0, Best_pers[1], 0.2, label = 'Best scenario', color = plt.get_cmap('tab10')(0.2),edgecolor = 'black')
plt.bar(X_axis + 1 + 0.2, Worst_pers[1], 0.2, label = 'Worst scenario', color = plt.get_cmap('tab10')(0.3),edgecolor = 'black')
ax2.set_xticks([0,1], labels=['$\mathit{Pers_\mathrm{new}}$','$\mathit{Area_\mathrm{new}}$'],fontsize = 11)
